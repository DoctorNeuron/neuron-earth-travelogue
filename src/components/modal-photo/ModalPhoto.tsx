...
export default function ModalPhoto() {
  ...
  return (
    <div className={classnames('absolute w-screen h-screen bg-black/50 z-4 top-0 left-0 flex justify-center items-center overflow-y-scroll', {
      'hidden': pic === ""
    })} onClick={() => { setPic("") }}>
      <div className='bg-[#1e1f21] min-w-[400px] rounded-md shadow-inner mt-3 mb-3' onClick={(e) => { e.stopPropagation() }}>
